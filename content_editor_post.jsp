...
<%	
	...
	editor = (User)session.getAttribute("user");
 	...
 	int user_id = editor.getUser_id();
 	
 	listLastPosts = ArticlesDAO.listEditorPosts(user_id, start, postsPerPage);
      ...
      <div class="row">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-md-8"> <!-- card body start -->
                       <div class="card-body ">
                        ...
                        <a href="./edit_article.jsp?art_id=<%=listLastPosts.get(i).getArt_id() %>" class="btn btn-primary btn-sm float-left">Read & Edit &rarr;</a>

                       <div class="d-sm-none d-lg-inline text-muted ml-4">
                        <em>Posted on <%=listLastPosts.get(i).getArt_pub_date() %></em>
                       </div> <!-- Footer end -->
                      </div>
                    </div> <!-- card body end -->
                  </div>
		...
		<% } // end of for loop %>
      	...
      	<ul class="pagination justify-content-center mb-4">
            <li class="page-item">
              <a class="page-link" href="./content_editor_post.jsp?page=<%=pageId-1%>">← Newer</a>
            </li>
            <li class="page-item ">
              <a class="page-link" href="./content_editor_post.jsp?page=<%=pageId+1%>">Older →</a>
            </li>
        </ul>
